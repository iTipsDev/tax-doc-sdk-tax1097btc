package org.taxdataexchange.usage.tax1097btc;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1097btc.models.*;
import org.taxdataexchange.docs.tax1097btc.utils.*;

public class Tax1097BtcDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1097Btc" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1097BtcPdfBuilder pdfBuilder = new Tax1097BtcPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1097Btc.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1097Btc.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1097Btc.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1097Btc.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1097Btc.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1097BtcDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1097BtcDocumentGenerator Done" );
