...
import irs.fdxtax641.jsonserializers.Tax1097BtcSerializer;
import irs.fdxtax641.map2objects.Map2Tax1097Btc;
import org.taxdataexchange.core.pdfbuilders.Tax1097BtcPdfBuilder;
...
public class Tax1097BtcDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1097Btc obj = Map2Tax1097Btc.generate( row );
        {
            String asJson = Tax1097BtcSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1097Btc.csv";
        ...
        String outputFileName = "Tax1097Btc.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1097BtcDocumentGenerator generator = new Tax1097BtcDocumentGenerator( );
